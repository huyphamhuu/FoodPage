...
import { ENDPOINTS } from '../../shared/models/constants/url';
...
export class FoodService {
  ...
  public getAll() : Observable<Food[]> {
    return this.http.get<Food[]>(ENDPOINTS.GET_ALL_FOODS);
  }
  public getFoodById(id: number): Observable<Food> {
    return this.http.get<Food>(ENDPOINTS.GET_FOOD_BY_ID.replace('{id}', id.toString()));
  }
  public addFood(food: Food): Observable<Food> {
    return this.http.post<Food>(ENDPOINTS.ADD_FOOD, food);
  }
  public updateFood(food: Food): Observable<Food> {
    return this.http.put<Food>(ENDPOINTS.UPDATE_FOOD, food);
  }
  public deleteFood(id: number): Observable<Food> {
    return this.http.delete<Food>(ENDPOINTS.DELETE_FOOD.replace('{id}', id.toString()));
  }
